...
fruitTypeRegex = "(苹果)|([桔橘]子)|(香蕉)|(梨)|(火龙果)|([沙砂]糖[桔橘])"
fruitCountRegex = "\\d+(?=[斤个])"
fruitUnitRegex = "(?<=\\d)[斤个]"
...
messages = Array.new
fruitMap = {}
fruitTypeRegexFilePath = dirPath.to_s + "/data/" + "fruitTypeRegex.txt"
fruitTypeMapFilePath = dirPath.to_s + "/data/" + "fruitTypeMap.rb"
...
finPath = dirPath.to_s + "/" + "message.txt"
print "  ->打开"
print finPath + "...."
fileString = "";
begin
...
foutPath = dirPath.to_s + "/" + "orderlist.txt"
